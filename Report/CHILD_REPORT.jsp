      ...
      <group name="G_CHILD_ID">
        ...
        <dataItem name="CHILD_ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Child Id">
          <dataDescriptor expression="SYS.CHILD.CHILD_ID"
           descriptiveExpression="CHILD_ID" order="1" width="22" scale="-127"
          />
        ...
        <dataItem name="NAME" datatype="vchar2" columnOrder="12" width="100"
         ...
         defaultLabel="Name">
          <dataDescriptor expression="SYS.CHILD.NAME"
        ...
        <dataItem name="GENDER" datatype="character"
         ...
         defaultLabel="Gender">
          <dataDescriptor expression="SYS.CHILD.GENDER"
        ...
        <dataItem name="ADMISSION_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Admission Date">
          <dataDescriptor expression="SYS.CHILD.ADMISSION_DATE"
           descriptiveExpression="ADMISSION_DATE" order="4" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="BIRTH_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Birth Date">
          <dataDescriptor expression="SYS.CHILD.BIRTH_DATE"
           descriptiveExpression="BIRTH_DATE" order="5" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="STAFF_ID" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Staff Id">
          <dataDescriptor expression="SYS.CHILD.STAFF_ID"
           descriptiveExpression="STAFF_ID" order="6" width="22" scale="-127"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ADOPTER_ID" oracleDatatype="number" columnOrder="17"
         ...
         columnFlags="33" defaultLabel="Adopter Id">
          <dataDescriptor expression="SYS.CHILD.ADOPTER_ID"
           descriptiveExpression="ADOPTER_ID" order="7" width="22"
           scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ROOM_ID" oracleDatatype="number" columnOrder="18"
         ...
         columnFlags="33" defaultLabel="Room Id">
          <dataDescriptor expression="SYS.CHILD.ROOM_ID"
           descriptiveExpression="ROOM_ID" order="8" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
...
<rw:dataArea id="MGCHILDIDGRPFR62">
<table class="OraTable">
<caption> Child Report </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBCHILDID62" asArray="no"/> class="OraColumnHeader"> Child Id </th>
   <th <rw:id id="HBNAME62" asArray="no"/> class="OraColumnHeader"> Name </th>
   <th <rw:id id="HBGENDER62" asArray="no"/> class="OraColumnHeader"> Gender </th>
   <th <rw:id id="HBADMISSIONDATE62" asArray="no"/> class="OraColumnHeader"> Admission Date </th>
   <th <rw:id id="HBBIRTHDATE62" asArray="no"/> class="OraColumnHeader"> Birth Date </th>
   <th <rw:id id="HBSTAFFID62" asArray="no"/> class="OraColumnHeader"> Staff
Id </th>
   <th <rw:id id="HBADOPTERID62" asArray="no"/> class="OraColumnHeader"> Adopter
Id </th>
   <th <rw:id id="HBROOMID62" asArray="no"/> class="OraColumnHeader"> Room
Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGCHILDID621" src="G_CHILD_ID">
   <tr>
    <td <rw:headers id="HFCHILDID62" src="HBCHILDID62"/> class="OraCellNumber"><rw:field id="FCHILDID62" src="CHILD_ID" nullValue="&nbsp;"> F_CHILD_ID </rw:field></td>
    <td <rw:headers id="HFNAME62" src="HBNAME62"/> class="OraCellText"><rw:field id="FNAME62" src="NAME" nullValue="&nbsp;"> F_NAME </rw:field></td>
    <td <rw:headers id="HFGENDER62" src="HBGENDER62"/> class="OraCellText"><rw:field id="FGENDER62" src="GENDER" nullValue="&nbsp;"> F_GENDER </rw:field></td>
    <td <rw:headers id="HFADMISSIONDATE62" src="HBADMISSIONDATE62"/> class="OraCellText"><rw:field id="FADMISSIONDATE62" src="ADMISSION_DATE" nullValue="&nbsp;"> F_ADMISSION_DATE </rw:field></td>
    <td <rw:headers id="HFBIRTHDATE62" src="HBBIRTHDATE62"/> class="OraCellText"><rw:field id="FBIRTHDATE62" src="BIRTH_DATE" nullValue="&nbsp;"> F_BIRTH_DATE </rw:field></td>
    <td <rw:headers id="HFSTAFFID62" src="HBSTAFFID62"/> class="OraCellNumber"><rw:field id="FSTAFFID62" src="STAFF_ID" nullValue="&nbsp;"> F_STAFF_ID </rw:field></td>
    <td <rw:headers id="HFADOPTERID62" src="HBADOPTERID62"/> class="OraCellNumber"><rw:field id="FADOPTERID62" src="ADOPTER_ID" nullValue="&nbsp;"> F_ADOPTER_ID </rw:field></td>
    <td <rw:headers id="HFROOMID62" src="HBROOMID62"/> class="OraCellNumber"><rw:field id="FROOMID62" src="ROOM_ID" nullValue="&nbsp;"> F_ROOM_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 <!-- Report Level Summary -->
 <tr>
  <td <rw:headers id="HFCountCHILDIDPerReport62" src="HBCHILDID62"/> class="OraTotalNumber">Count: <rw:field id="FCountCHILDIDPerReport62" src="CountCHILD_IDPerReport" nullValue="&nbsp;"> F_CountCHILD_IDPerReport </rw:field></td>
